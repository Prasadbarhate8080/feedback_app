  ...
  return (
    <div className='max-w-4xl  mx-auto mt-6 p-4'>
      ...
      <div>
        ...
        <div>
          <textarea
            className='flex mt-2 min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm 
            ...
            name='content'
            id=':R1auuuda:-form-item'
            aria-describedby=':R1auuuda:-form-item-description'
            aria-invalid='false'
            value={message}
            onChange={e => {
      ...
      <div className='p-2 mt-4 text-center'>
        <button
          className={`${message ? 'bg-black' : 'bg-gray-600'} text-white px-3 py-2 font-semibold  rounded-md`}
          onClick={() => {
            if (message.length < 6) {
      ...
      <div className='mt-4 border p-6 rounded-md'>
        ...
        <div className='flex flex-col gap-4 mt-4'>
          <div
            className='p-3 border rounded-md text-center hover:bg-gray-50 cursor-pointer'
            onClick={e => {
              setMessage(e.currentTarget.innerText);
            }}
          >
            Whats a hobby youve recently started?
          </div>
          <div
            className='p-3 border rounded-md text-center hover:bg-gray-50 cursor-pointer'
            onClick={e => {
          ...
          >
            If you could have dinner with any historical figure, who would it
            be?{' '}
          </div>
          <div
            className='p-3 border rounded-md text-center hover:bg-gray-50 cursor-pointer'
          ...
          >
            Whats a simple thing that makes you happy?
          </div>
        </div>
      </div>
      ...
      <div className='text-center mt-6 mb-10'>
        <button className='bg-gray-800 text-white px-3 py-2 font-semibold text-  rounded-md'>
          Create Your Account
        </button>
      </div>
    </div>
